      ...
      <form action="php/feedback.php" method="post" class="student-form">
        <div class="student-details">
          ...
          <select name="section" id="section">
            ...
            <option value="B">Sec C</option>
            <option value="A">Sec D</option>
            <option value="B">Sec E</option>
          </select>
          <br />

          <label for="subject">Subject</label>
          <select name="subject" id="subject">
            <option value="CNS">Computer Network Security</option>
            <option value="ML">Machine Learning</option>
            <option value="BDA">Big Data Analytics</option>
            <option value="CD">Compiler Desgine</option>
          </select>
          <br />
        </div>
